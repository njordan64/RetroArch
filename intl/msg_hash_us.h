...
MSG_HASH(
   MENU_ENUM_SUBLABEL_CLOUD_STORAGE_GOOGLE_DEFAULT_CREDS,
   "For better performance use a private Google API project."
   )
MSG_HASH(
...
MSG_HASH(
   MENU_ENUM_SUBLABEL_CLOUD_STORAGE_GOOGLE_CLIENT_ID,
   "Client ID of the Google API project to use."
   )
MSG_HASH(
...
MSG_HASH(
   MENU_ENUM_SUBLABEL_CLOUD_STORAGE_GOOGLE_CLIENT_SECRET,
...
MSG_HASH(
   MENU_ENUM_SUBLABEL_CLOUD_STORAGE_ONEDRIVE_DEFAULT_CREDS,
   "For better performance use a private MS OneDrive API project."
   )
MSG_HASH(
...
MSG_HASH(
   MENU_ENUM_SUBLABEL_CLOUD_STORAGE_ONEDRIVE_CLIENT_ID,
   "Leave blank to use default."
   )
MSG_HASH(
