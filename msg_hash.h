...
enum msg_hash_enums
{
   ...
   MENU_LABEL(CLOUD_STORAGE_SETTINGS),
   ...
   /* Cloud Storage */
   MENU_LABEL(CLOUD_STORAGE_ENABLE),
   MENU_LABEL(CLOUD_STORAGE_PROVIDER),
   MENU_LABEL(CLOUD_STORAGE_GOOGLE_DEFAULT_CREDS),
   MENU_LABEL(CLOUD_STORAGE_GOOGLE_CLIENT_ID),
   MENU_LABEL(CLOUD_STORAGE_GOOGLE_CLIENT_SECRET),
   MENU_LABEL(CLOUD_STORAGE_ONEDRIVE_DEFAULT_CREDS),
   MENU_LABEL(CLOUD_STORAGE_ONEDRIVE_CLIENT_ID),
   MENU_LABEL(CLOUD_STORAGE_AUTHORIZE_STATUS),
   ...
   MENU_LABEL(CLOUD_STORAGE_AUTHORIZE),
