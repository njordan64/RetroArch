      ...
      switch (type)
      {
         ...
         default:
             ...
             * all this manually inside this menu driver */
                  ...
                  string_is_equal(label, msg_hash_to_str(MENU_ENUM_LABEL_CLOUD_STORAGE_SETTINGS)) ||
                  string_is_equal(label, msg_hash_to_str(MENU_ENUM_LABEL_CLOUD_STORAGE_AUTHORIZE)) ||
